...
const BLOG = {
  ...
  NOTION_PAGE_ID: process.env.NOTION_PAGE_ID || '071d4d94cd4340c8a4ca73767744340d',
  ...
  SINCE: process.env.NEXT_SINCE || 2000, // e.g if leave this empty, current year will be used.
